...
test("home, auth, and design-system navigation remain synchronized without refresh", async ({ page }) => {
  ...
  await expect(page.getByText("Build Slice 5: Creator and depicted-person verification")).toBeVisible();
...
test("health endpoint returns the Slice 5 contract", async ({ request }) => {
