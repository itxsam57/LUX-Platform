...
| REG-003 | Button changes text without completing real workflow | Every control performs authorized durable action and reports success/failure | future integration/E2E per action ID | BLOCKED |
...
| REG-010 | White screen, silent crash, or uncontrolled error | Controlled 404/error state; no uncaught page or console errors | Playwright page-error/console/404 checks | ACTIVE |
